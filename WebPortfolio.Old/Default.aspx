<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" MasterPageFile="/masters/Main.Master" Inherits="WebPortfolioOld._Default" %>
...
<asp:Content ContentPlaceHolderID="ContentSectionPlaceHolder" runat="server">
		    ...
		    <asp:Image runat="server" ID="sectionImage" CssClass="titleImage" ImageUrl="/images/" AlternateText="Welcome!" />
    <div id="description">
    <div id="s_welcome" class="section">
    <img src="images/section_pages/IMG_4380_a.jpg" alt="Meet Me!" style="padding:0; margin: 0 0 5x 20px; width:250px; border:5px solid white;" />
    <div style="clear:right; float:right; width:250px; text-align:right;"><em>phone: 585.732.9515<br />
    ...
    <p>
    Hello and welcome to my portfolio! I'm Anna Steglinski, a recent graduate (May 2010) of Rochester Institute of Technology where I studied <a href="http://igm.rit.edu/node/142">New Media Interactive Development</a> (New Media I.D.). As a New Media I.D. student I specialize in web development with a focus in ASP.NET developement, and C# web programming with additional experience with <a href="http://www.jquery.com">JQuery</a>.Currently I am a Web Developer and User Experience Expert for <a href="http://www.brandintegrity.com">Brand Integrity</a>, a position that I accepted upon graduation from RIT in May 2010. I am working to help support and improve the <a href="http://www.potentialpoint.com">Potential Point</a> platform as well as provide support to our clients.</p> 
...
<p>I am not currently seeking employment, however you can feel free to look around my portfolio or contact me if you have any questions.
</p>
    </div>
    ...
    The SociaLaser team consists of 6 members:</p>
    <ul>
    ...
    <p>Together we are working to create an <em>"an immersive environment synchronizing laser light mechanics with physical user input through a multi-touch interface and laser light display."</em>
    ...
    <div id="s_4" class="section">
        ...
        <a href="/documents/resume.pdf" target="_blank">my resume</a></em></div>
       <p>
        I'm Anna Steglinski! I'm <asp:Literal runat="server" ID="litAge" /> and recently graduated from Rochester Institute of Technology in May of 2010 with a degree in <a href="http://igm.rit.edu/node/142">New Media Interactive Development</a> (New Media I.D.). I was born and raised in the Western Massachusetts area, living in Huntington, MA until 2006 when I moved out to Rochester, NY to attend school. Having finally graduated with my degree in Web Development, something I've been working towards for about 10 years now, I am a Web Developer and User Experience Expert for <a href="http://www.brandintegrity.com">Brand Integrity</a> where I am working to help support and improve the <a href="http://www.potentialpoint.com">Potential Point</a> platform as well as provide support to our clients.</p> 
        ...
        <p>For a full list of my skills please reference my <a href="/documents/resume.pdf" target="_blank">resume</a>.</p></div>
    </div>
</asp:Content>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Section.aspx.cs" MasterPageFile="/masters/Main.Master" Inherits="WebPortfolio._Section" %>
            ...
            <asp:UpdatePanel runat="server" ID="pnlThumbUpdate" UpdateMode="Conditional" ChildrenAsTriggers="false">
                <ContentTemplate>
                    <asp:ListView ID="lvThumbs" runat="server" ItemPlaceholderID="itemsGoHere">
                        ...
                        <ItemTemplate>
                        <!--<li><img src='<%#"/images/thumbs/" + Eval("ItemFolderName") + "/" + Eval("ItemImageName")%>' /></li>-->
                            <li>
                                <asp:LinkButton runat="server" OnClick="LoadImage" ID="ThumbLink" OnClientClick="hideText();">
                                    <asp:Image runat="server" ID="thumbImage" ImageUrl='<%#"/images/thumbs/" + Eval("ItemFolderName") + "/" + Eval("ItemImageName")%>' AlternateText='<%#Eval("ItemId") %>' />
                                </asp:LinkButton>
                            </li>
                        </ItemTemplate>
                    </asp:ListView> 
